...
# Sen ympärille piirretään pienin mahdollinen neliö B siten, että ympyrä A jää kokonaan neliön sisäpuolelle. Neliön nurkkapisteet ovat tällöin (-1,-1), (1,-1), (1,1) ja (-1,1). 
# Jos neliön sisälle arvotaan satunnaisesti suuri määrä pisteitä, osuu niistä myös ympyrän sisälle likimain niin suuri osuus kuin ympyrän pinta-ala on neliön pinta-alasta 
...
# Olkoon N tämä pisteiden kokonaismäärä. (var)
# Jokaisesta neliön B sisään arvotusta pisteestä testataan vuorollaan, jääkö se myös yksikköympyrän A sisälle. (logic {if})
# Olkoon n ympyrän sisälle jäävien pisteiden kokonaismäärä.  (var)
# Nyt pätee n/N≈π/4, josta saadaan π≈4n/N. (logic)
...
os.system("cls")
# INPUT
N = int(input("Anna pisteiden määrän: "))
# LOGIC
n: int = 0
i = 1
while i <= N:
